...
public class Photo implements Serializable
{
	 ...
	 *            The file contents
	 */
	public void setArquivo(byte[] file)
	{
		this.arquivo = file;
	}
	 ...
	 */
	public Photo(String fileName, byte[] file, String title, String photoDescription)
	{
		this(fileName, file);
		this.title = title;
		this.photoDescription = photoDescription;
	...
	public final boolean equals(Object obj)
	{
		...
		return ((fileName == null ? other.fileName == null : fileName.equals(other.fileName)) && Arrays.equals(arquivo,
				other.arquivo));
	}
